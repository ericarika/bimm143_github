...
there are lot’s of ways to make plots in R i.e lots of graphics in R.
These include so called “base R” (like the `plot()`) and add on packages
like **ggplot2**
...
3.  The **geom\_** or geometry i.e the plot tyep such as points, lines
    etc.
...
```
    ...
    <ggplot2::labels> List of 3
     $ x    : chr "GDP per capita"
     $ y    : chr "Life Expectancy"
     $ title: chr "GDP per Capita vs Life Expectancy"
